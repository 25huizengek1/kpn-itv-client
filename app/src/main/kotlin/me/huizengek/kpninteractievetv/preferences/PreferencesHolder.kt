...
@Stable
data class SharedPreferencesProperty<T> internal constructor(
...
open class PreferencesHolder(
    ...
    fun nullableString(defaultValue: String?) = sharedPreferencesProperty(
        getValue = { getString(it, defaultValue) },
        setValue = { k, v -> putString(k, v) },
        defaultValue
    )
